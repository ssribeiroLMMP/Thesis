...
class Inputs():
    def __init__(self):
        #%%############ Case Definition    ##############################
        self.caseId = 'TransWellSimulator_MedInitYieldStress_10000s_2' ## If name already exists in folder ./PostProcessing/Cases, 
...
#        self.dt = dynamicTimestep(self.t0,self.dtMax,self.gging Options   ###############################
        ...
        self.tau0 = 40 #19.019           # Dinamic Yield Stress               
