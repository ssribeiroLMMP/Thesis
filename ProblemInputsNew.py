...
#        self.dt = dynamicTimestep(self.t0,self.dtMax,self.gging Options   ###############################
        ...
        # Model Equation
        self.shrinkageEquation = 'rhoMax-((rhoMax-rhoMin)/(1 + exp(Inclination*(-t+t0)))+rhoMin)+rhoMin'
    ...
    def setUserInputs(self,TestData,i):
        
        # List Test Altered Columns
        Columns = list(TestData)
        
        # Loop through Columns
        for j in Columns:
            setattr(self,TestData[j,i],inputfile)
        return self
    ...
    def Calculations(self):
        ...
        # Model Equation
        self.shrinkageModel = Expression(self.shrinkageEquation,\
...
def TestMatrixDataframe(inputfile):
